...
valuation/            Used-vs-new pricing indicator tool (Python + CSVs) — a separate
                       personal research utility, not part of the published site; see
                       valuation/README.md. Migrated here from a formerly separate
                       `car-shopping-indicators` workspace, since retired.
```
